...
/**
 * MobileSettingsSectionPage — one real mobile page per Settings section
 * (`/settings/<section>`), replacing the old bottom-sheet-per-section
 * design. All ten sections share this component, switching on `section`;
 * state comes from SettingsFormContext so edits survive navigating between
 * sections before saving. The desktop SettingsScreen (tabs, no route change)
 * is untouched — this file only backs the mobile routes.
 */

import { useRef, useState } from "react";
import {
  School, Upload, AlertTriangle, FileText, Eye,
} from "lucide-react";
import { YearsTermsPanel } from "@/screens/desktop/AcademicCalendarScreen/YearsTermsPanel";
import { FeeStructurePanel } from "@/screens/desktop/FeesScreen/FeeStructurePanel";
import { MobileSheet } from "@/components/mobile/ui/MobileSheet/MobileSheet";
import kit from "@/components/mobile/ui/MobileFormKit/MobileFormKit.module.css";
import { useSettingsFormContext } from "./SettingsFormContext";
import { GH_REGIONS, SCHOOL_TYPES, type Form } from "@/screens/desktop/SettingsScreen/useSettingsForm";
import styles from "./MobileSettingsContent.module.css";

export type SectionId = "profile" | "academic" | "branding" | "fees" | "attendance" | "gradebook" | "security" | "notifications" | "offline" | "integrations";
...
export function MobileSettingsSectionPage({ section }: { section: SectionId }) {
  const {
    ...
    academicYears, classes, feeStructureRows,
