...
interface RoomRow { id: string; name: string; capacity: number; occupants: Occupant[] }
interface HostelRow { id: string; name: string; rooms: RoomRow[] }
...
interface FlatRoom { hostelId: string; hostelName: string; room: RoomRow }
