...
export interface YearOption { id: string; name: string; isCurrent: boolean }

export interface ScholarshipsContentProps {
  scholarships: ScholarshipRow[];
  students: StudentOption[];
  years: YearOption[];
}
type Props = ScholarshipsContentProps;

export function fmtValue(type: "percent" | "fixed", value: number) {
